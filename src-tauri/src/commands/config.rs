...
pub async fn get_official_providers() -> Result<Vec<OfficialProvider>, String> {
    ...
    let providers = vec![
        ...
        //     requires_api_key: true,
        //     docs_url: Some("https://ai.google.dev/gemini-api/docs".to_string()),
        //     suggested_models: vec![
        //         SuggestedModel {
        //             id: "gemini-3-pro-preview".to_string(),
        //             name: "Gemini 3 Pro Preview".to_string(),
        //             description: Some("最新预览版旗舰模型".to_string()),
        ...
        //             description: Some("快速高效版本".to_string()),
        //             context_window: Some(1000000),
        //             max_tokens: Some(8192),
        //             recommended: false,
        //         },
        ...
        //             description: Some("旗舰模型".to_string()),
        //             context_window: Some(128000),
        //             max_tokens: Some(8192),
        //             recommended: false,
        //         },
